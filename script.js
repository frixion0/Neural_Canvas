...
const imageModels = [
    ...
    { id: 'img4', name: 'Imagen 4 (Google)', description: 'Advanced model for high-quality, photorealistic results. Uses proxy.', isUncen: false },
    { id: 'img3', name: 'Imagen 3 (Google)', description: 'Previous version of Imagen, still provides strong performance. Uses proxy.', isUncen: false },
